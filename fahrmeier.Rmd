...
star_nodes = create_nodes(    
  nodes = c('reg', 'GLM', 'GAM', 'mixed', 'star', 'spatial', 'GP'),
  label = c('Regression', 'GLM', 'GAM', 'Mixed\nModels', 'STAR', 'Spatial', 'GP'),
  # type = 'a',
  # value = 1,
  style = 'filled',
  shape = 'circle',
...
star_edges = create_edges(
  from = c('GP', 'star', 'star', 'star', 'GAM', 'spatial', 'GAM','mixed', 'GAM', 'spatial', 'GLM'),
  to =   c('star', 'GAM', 'mixed', 'spatial', 'mixed', 'mixed', 'spatial','GLM', 'GLM', 'GLM', 'reg'),
  # rel = c('a'),
  arrowhead='dot',
  arrowsize='.5',
  arrowtail='',
